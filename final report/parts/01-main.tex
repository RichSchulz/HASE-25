...
Another reason for the resilience of developer workflows could be the availability of alternative AI tools. Although the ChatGPT website was blocked, access to the OpenAI API remained possible \cite{saba2023chatgptbloccato}. Access to AI tools integrated into development environments, such as GitHub Copilot, was also unaffected.

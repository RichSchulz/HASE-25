...
def main():
    ...
    jobs_conn = sqlite3.connect(f"{Path(__file__).resolve().parent.parent}/large_data/commits_all.sqlite3")
    ...
    commits_conn = sqlite3.connect(f"{Path(__file__).resolve().parent.parent}/large_data/data_commits.sqlite3")
    ...
    files_conn = sqlite3.connect(f"{Path(__file__).resolve().parent.parent}/large_data/data_files.sqlite3")

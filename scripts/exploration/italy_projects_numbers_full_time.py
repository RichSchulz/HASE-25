...
Includes data from before, during and after the ban.
"""
...
INPUT_PATH = f"{Path(__file__).resolve().parent.parent}/large_data/commits_all_italy.csv"
OUTPUT_PATH = f"{Path(__file__).resolve().parent}/data/italy_projects_fulltime.csv"
